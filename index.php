        ...
        <div class="row g-5">
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="about-item">
                    ...
                    <p class="mb-4">
                        Established in 2025, Meenakanchan Pure H2O Private Limited is a modern, forward-thinking bottled water company committed to delivering the highest quality mineral water to consumers across India. Inspired by trusted brands like Bisleri, we aim to become a household name by offering crystal-clear, refreshing, and safe drinking water processed through state-of-the-art purification systems.
                    </p>
                    <p class="mb-4">
        ...
        <div class="row gx-0 gy-4 align-items-center">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="bg-transparent">
                    <img src="img/water.png?v=1.0" class="img-fluid w-100" alt="">
                </div>
            </div>
...
<div class="container-fluid product py-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                <div class="product-item">
                    <img src="img/200ml.png?v=1.0" class="img-fluid w-100 rounded-top" alt="Image">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                <div class="product-item">
                    <img src="img/500ml.png?v=1.0" class="img-fluid w-100 rounded-top" alt="Image">
                    <div class="product-content bg-light text-center rounded-bottom p-4">
                        <p>500 ml</p>
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                <div class="product-item">
                    <img src="img/1l.png?v=1.0" class="img-fluid w-100 rounded-top" alt="Image">
                    <div class="product-content bg-light text-center rounded-bottom p-4">
                        <p>1 Litre</p>
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                <div class="product-item">
                    <img src="img/2l.png?v=1.0" class="img-fluid w-100 rounded-top" alt="Image">
                    <div class="product-content bg-light text-center rounded-bottom p-4">
                        <p>2 Litres</p>
                        <a href="#" class="h4 d-inline-block mb-3">UV Water Bottle</a>
                        <!-- <p class="fs-4 text-primary mb-3">$100:00</p> -->
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                <div class="product-item">
                    <img src="img/5l.png?v=1.0" class="img-fluid w-100 rounded-top" alt="Image">
                    <div class="product-content bg-light text-center rounded-bottom p-4">
                        <p>5 Litrs</p>
                        <a href="#" class="h4 d-inline-block mb-3">UV Water Bottle</a>
                        <!-- <p class="fs-4 text-primary mb-3">$100:00</p> -->
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                <div class="product-item">
                    <img src="img/20l.png?v=1.0" class="img-fluid w-100 rounded-top" alt="Image">
                    <div class="product-content bg-light text-center rounded-bottom p-4">
                        <p>20 Litres (Jar)</p>
                        <a href="#" class="h4 d-inline-block mb-3">UV Water Bottle</a>
                        <!-- <p class="fs-4 text-primary mb-3">$100:00</p> -->
    ...
    <div class="container py-4">
        <p class=" text-center">Each bottle is sealed with care and tested to meet ISI and FSSAI standards, ensuring that you receive only the best.</p>
    </div>
</div>
<!-- Products End -->
        ...
        <div class="row g-5">
            ...
            <div class="col-md-8 col-lg-4 col-xl-4">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="javascript:void(0)"><i class="fas fa-angle-right me-2"></i> Competitive Pricing</a>
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Meenakanchan Pure H2O Private Limited</a>, All right reserved.</span>
            </div>
